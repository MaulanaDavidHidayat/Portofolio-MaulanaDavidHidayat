...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/MaulanaDavidHidayat",
      };
  ...
  const projectUrl = `https://mauviidev.site.je/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Maulana David Hidayat</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Maulana David Hidayat — Student Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Maulana David Hidayat`}
        />
        <meta
