...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/MaulanaDavidHidayat", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/maulana-david-hidayat", label: "LinkedIn Profile" },
  { icon: Instagram, link: "https://www.instagram.com/ln.mauvii", label: "Instagram Profile" }
];
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Maulana David Hidayat — Student Developer</title>
        <meta
          name="description"
          content="Website resmi Maulana David Hidayat, Student Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://mauviidev.site.je" />
        <meta
          property="og:title"
          content="Maulana David Hidayat — Student Developer"
        />
        <meta
          property="og:description"
          content="Website resmi dan portofolio Maulana David Hidayat, Student Developer."
        />
        <meta property="og:url" content="https://mauviidev.site.je" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json">{`
          {
            "@context": "https://schema.org",
            "@type": "Person",
            "name": "Maulana David Hidayat",
            "jobTitle": "Student Developer",
            "url": "https://mauviidev.site.je",
            "sameAs": [
              "https://github.com/MaulanaDavidHidayat/",
              "https://www.linkedin.com/in/maulana-david-hidayat/",
              "https://www.instagram.com/ln.mauvii/"
            ]
          }
        `}</script>
      </Helmet>
