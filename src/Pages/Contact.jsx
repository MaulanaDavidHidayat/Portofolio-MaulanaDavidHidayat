...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // GANTI FORM_ID_KAMU dengan Form ID dari Formspree
      const formspreeUrl = "https://formspree.io/f/xyezkjwr";
      ...
      // Subject email yang diterima
      submitData.append("_subject", "Pesan Baru dari Website Portfolio");

      const response = await axios.post(formspreeUrl, submitData, {
        headers: {
      ...
      if (error.code === "ECONNABORTED") {
        Swal.fire({
          title: "Waktu Habis!",
          text: "Pengiriman terlalu lama. Silakan coba lagi.",
          icon: "warning",
          confirmButtonColor: "#6366f1",
        });
        ...
        Swal.fire({
          ...
          text:
            ...
            "Pesan gagal dikirim. Silakan periksa Form ID Formspree Anda.",
          icon: "error",
          confirmButtonColor: "#6366f1",
        });
        ...
        Swal.fire({
          ...
          text: "Tidak dapat terhubung ke Formspree. Periksa koneksi internet Anda.",
          icon: "error",
          confirmButtonColor: "#6366f1",
        });
      } else {
