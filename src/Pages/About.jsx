...
const AboutPage = () => {
  ...
  useEffect(() => {
    const updateStats = () => {
      ...
      const startDate = new Date("2024-07-20"); // Replace with your actual start date
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Saya adalah siswa SMK Negeri 1 Kraksaan jurusan Rekayasa Perangkat
              Lunak yang memiliki ketertarikan pada dunia coding dan teknologi.
              Saya sedang mengembangkan kemampuan dalam pembuatan website,
              aplikasi, dan pengembangan perangkat lunak. Saya senang belajar
              hal baru, mencoba berbagai teknologi, dan mengembangkan project
              sebagai bagian dari proses belajar saya.
            </p>
